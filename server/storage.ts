...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const demoPortfolio: Portfolio = {
      ...
      userId: 1,
      totalValue: "51300.00",
      cryptoValue: "8600.00",     // BTC + ETH (demo spot values)
      stablecoinValue: "2300.00", // USDT + USDC
      fiatValue: "39000.00",      // AUD-equivalent of all fiat wallets
      investmentValue: "12300.00",
      monthlyPnl: "382.50",
      monthlyPnlPercent: "0.75",
      updatedAt: new Date(),
    };
