  ...
  private initializeData() {
    ...
    const demoInvestmentProducts: InvestmentProduct[] = [
      ...
      },
      {
        ...
        investmentStrategy: "Passive exposure to the price performance of Bitcoin through a regulated, institutionally structured fund. Designed for investors seeking pure Bitcoin price exposure without the operational complexities of direct crypto custody.",
        targetNetIrr: "Variable (tracks Bitcoin price)",
        grossIrr: null,
        moic: null,
        term: "Open-ended",
        structure: "Passive tracker fund",
        distributions: "None (capital appreciation only)",
        liquidity: "monthly",
        minimumInvestment: "50000.00",
        riskProfile: "high",
        returnType: "capital_gains",
      ...
      {
        id: 9,
        name: "Early-Stage Token Fund",
        category: "digital_assets",
        subCategory: "token_fund",
        investmentStrategy: "Participates in pre-launch token investments of blockchain and Web3 projects. Combines venture-style diligence with liquid token opportunities, targeting asymmetric returns from early access and strategic unlocks.",
        targetNetIrr: "25–40%+",
        grossIrr: null,
        moic: null,
        term: "4–6 years",
        structure: "Hybrid (venture equity + early token allocations)",
        distributions: "Event-based (token unlocks/sales)",
        liquidity: "illiquid",
        minimumInvestment: "100000.00",
      ...
      },
      {
        ...
        investmentStrategy: "Broad-based blockchain exposure via a diversified portfolio including early-stage equity, liquid tokens, and select yield-generating DeFi strategies. Focuses on transformative blockchain infrastructure and financial applications.",
        targetNetIrr: "20–30%",
        grossIrr: null,
        moic: null,
        term: "5–7 years",
        structure: "Diversified fund (VC + tokens + DeFi)",
        distributions: "Periodic based on liquidity events",
        liquidity: "illiquid",
        minimumInvestment: "100000.00",
        riskProfile: "high",
        returnType: "blended",
