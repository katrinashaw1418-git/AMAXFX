...
const NAVY_BTN  = "bg-[#0d1b3e] hover:bg-[#162d55] text-white font-semibold";
const WHITE_BTN = "bg-white hover:bg-white/90 text-[#0d1b3e] font-semibold";
        ...
        <header>
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex-1 flex items-center gap-2">
              <img src="/amax-logo-new.png" alt="AMAX GLOBAL" className="h-14 w-auto" />
              <span className="font-bold text-white text-2xl tracking-widest leading-tight">AMAX<br/>GLOBAL</span>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={step.step} className="relative text-center">
                ...
                <div className="relative z-10 inline-flex items-center justify-center w-16 h-16 rounded-full text-[#0d1b3e] text-xl font-bold mb-5 bg-white">
                  {step.step}
                </div>
