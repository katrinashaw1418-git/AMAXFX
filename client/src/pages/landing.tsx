  ...
  return (
    <div className="min-h-screen text-white" style={{ background: "#07111f" }}>
      ...
      <div className="sticky top-0 z-50">
        <div className="text-white/80 text-sm text-center py-2 px-6" style={{ background: "#0a1928", borderBottom: "1px solid #152e4a" }}>
        ...
        <header style={{ background: "rgba(7,17,31,0.97)", borderBottom: "1px solid #152e4a" }} className="backdrop-blur">
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            <img src={amaxLogo} alt="AMAX Global" className="h-16 w-auto rounded-md" />
