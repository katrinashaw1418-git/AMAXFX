          ...
          {[
            ...
            { title: "5. Custody and Safeguarding of Funds", body: <>
              ...
              <ul className="list-disc list-inside space-y-2 text-white/80 mb-3">
                <li><strong>Ledger entitlement:</strong> Balances displayed in your AMAX account represent your beneficial entitlement recorded in AMAX's internal ledger. They do not represent funds held directly by AMAX Global Pty Ltd.</li>
                ...
                <li><strong>Digital assets:</strong> Digital asset transactions are executed via Independent Reserve Pty Ltd (ABN 46 164 681 443, AUSTRAC DCE-100461150-001), a licensed digital currency exchange that acts as settlement custodian. AMAX does not hold, receive, or custody digital assets on your behalf.</li>
                <li><strong>No discretionary control:</strong> AMAX does not exercise discretionary control over customer funds beyond executing customer-directed transaction instructions.</li>
