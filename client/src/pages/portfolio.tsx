      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-sm font-bold leading-tight whitespace-nowrap overflow-hidden text-ellipsis">${totalPortfolioValue.toLocaleString()}</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-sm font-bold leading-tight whitespace-nowrap overflow-hidden text-ellipsis">${cryptoValue.toLocaleString()}</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-sm font-bold leading-tight whitespace-nowrap overflow-hidden text-ellipsis">${fiatValue.toLocaleString()}</p>
            <p className="text-xs text-gray-600 mt-1">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-sm font-bold leading-tight whitespace-nowrap overflow-hidden text-ellipsis">${investmentValue.toLocaleString()}</p>
            <p className="text-xs text-gray-600 mt-1">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className={`text-sm font-bold leading-tight whitespace-nowrap overflow-hidden text-ellipsis ${monthlyPnl >= 0 ? 'text-secondary' : 'text-destructive'}`}>
