        ...
        <div className="space-y-10">
          ...
          <Section id="s1" title="1. About AMAX">
            ...
            <div className="mt-4 space-y-2">
              ...
              <p>AMAX maintains internal ledger accounts that record each customer's balance entitlements across multiple currencies and digital assets. <strong>These ledger balances do not represent funds beneficially or legally owned by AMAX.</strong> Fiat currency balances are maintained with regulated Australian banking partners in omnibus accounts; AMAX's internal ledger records each customer's proportional entitlement within those accounts.</p>
              ...
              <p>AMAX relies on regulated third-party providers for the safeguarding and processing of customer funds and digital assets. AMAX conducts appropriate due diligence and ongoing monitoring of those providers as part of its AML/CTF risk management and outsourcing governance obligations.</p>
            </div>
          </Section>
