  ...
  return (
    <div className="min-h-screen text-white" style={{ background: "#07111f" }}>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-sm mb-1 text-white/60">Anti-Money Laundering &amp; Counter-Terrorism Financing Policy</p>
        ...
        <div className="space-y-8 leading-relaxed text-white/80">
          ...
          {[
            ...
            { title: "2. AUSTRAC Registration", body: <><p>AMAX is registered (or in the process of registration) with AUSTRAC as a reporting entity in the following categories:</p><ul className="list-disc list-inside space-y-1 mt-2 text-white/80"><li>Digital Currency Exchange (DCE)</li><li>Remittance Network Provider (RNP)</li><li>Independent Remittance Dealer (IRD)</li></ul></> },
            { title: "3. Know Your Customer (KYC)", body: <><p>All users are required to verify their identity before accessing AMAX services. Our KYC process includes:</p><ul className="list-disc list-inside space-y-1 mt-2 text-white/80"><li>Collection and verification of government-issued identity documents</li><li>Proof of address verification</li><li>Politically Exposed Person (PEP) and sanctions screening</li><li>Enhanced due diligence for higher-risk customers</li></ul></> },
